...
public:
  MyNode()
    ...
    abort_service =
        create_service<Empty>("abort", std::bind(&MyNode::abort, this, _1, _2),
                              rmw_qos_profile_services_default, group);
    stop_service =
        create_service<Empty>("stop", std::bind(&MyNode::stop, this, _1, _2),
                              rmw_qos_profile_services_default, group);
    pause_service =
        create_service<Empty>("pause", std::bind(&MyNode::pause, this, _1, _2),
                              rmw_qos_profile_services_default, group);
    resume_service = create_service<Empty>(
        "resume", std::bind(&MyNode::resume, this, _1, _2),
        rmw_qos_profile_services_default, group);
    ...
    tst_executor_registry->registerNodeExecutor<ExploreExecutor>(
        tst_registry->model("explore"));
